...
<label for="training_track">Choose a training track:</label>
  <select name="trainin_track" id="training_track">
  ...
  <select name="class_of_degree" id="class_of_degree">
  ...
  <input type="checkbox" id="nysc" name="nysc" value="nysc" />
  </div>
<div className="checkbox">
<label for="vehicle2"> I have 0-3years experience in my chosen field</label>
  <input type="checkbox" id="experience" name="experience" value="experience"/>
                ...
                <Button value='Register' styleClass='blue-button'></Button>
